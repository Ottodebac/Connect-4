...
let resetButton1 = document.getElementById("winreset1");
let resetButton2 = document.getElementById("winreset2");
...
doomDeath.addEventListener("click", function () {
  doomKittyf();
  doomDeath.innerText = "DoomKitty On";
});
...
standardbtn.addEventListener("click", function () {
  standardTheme();
  doomDeath.innerText = "DoomKitty Theme";
});
...
function standardTheme() {
  ...
  doomDeath.innerHTML = "Doom Kitty Theme";
}
